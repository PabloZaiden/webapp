  ...
  return (
    <Page className="sink-stack">
      ...
      <Panel title="Diagnostics">
        ...
        <div className="sink-row"><span><strong>Manifest</strong><small>/manifest.webmanifest via framework PWA metadata</small></span><Badge variant="info">static</Badge></div>
